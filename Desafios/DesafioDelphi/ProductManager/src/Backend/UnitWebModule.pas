...
type
  TProductManagerWebModule = class(TWebModule)
...
var
  WebModuleClass: TComponentClass = TProductManagerWebModule;
...
uses
  ...
  Backend.Controller.ProductControllerV1;

procedure TProductManagerWebModule.WebModuleCreate(Sender: TObject);
begin
  ...
  FMVC.AddController(TProductManagerController);
...
procedure TProductManagerWebModule.WebModuleDestroy(Sender: TObject);
begin
  FMVC.Free;
end;
