    ...
    while True:
        ...
        for _ in range(50):
            ...
            for i in range(batch_size):
                ...
                # decidir se o pokemon ira ou não aparecer na imagem
...
def make_model(img_h, img_w, hp_adam_lr):
    ...
    # agora são 5 outputs, as 4 primeiras para a caixa, a ultima para se o objeto esta ou não na imagem
...
def custom_loss(y_true, y_pred):
    ...
    # multimplicando-se a loss do objeto pelo ultimo elemento, a loss será zero caso o elemento não exista
